...
$expectedSchemas = [
    'site_config' => [
        ...
        'review_enabled' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '1'],
        'scheduled_assessments_enabled' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '1'],
        'qb_danger_zone_enabled' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '1'],
        'assessment_timer_enabled' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '0'],
        'assessment_timer_minutes' => ['type' => 'int', 'null' => 'NO', 'default' => '60'],
        'assessment_timer_warning_minutes' => ['type' => 'int', 'null' => 'NO', 'default' => '5'],
        'assessment_timer_expiry_behavior' => ['type' => 'varchar', 'null' => 'NO', 'default' => 'message_only'],
        'email_templates' => ['type' => 'longtext', 'null' => 'YES'],
        'ai_enabled' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '0'],
        'ai_provider' => ['type' => 'varchar', 'null' => 'NO', 'default' => 'ollama'],
        'ai_base_url' => ['type' => 'varchar', 'null' => 'YES'],
        'ai_api_key' => ['type' => 'varchar', 'null' => 'YES'],
        'ai_model_chat' => ['type' => 'varchar', 'null' => 'YES'],
        'ai_model_fast' => ['type' => 'varchar', 'null' => 'YES'],
        'ai_model_fallback' => ['type' => 'varchar', 'null' => 'YES'],
        'ai_feature_summary_enabled' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '0'],
        'ai_feature_devplan_enabled' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '0'],
        'ai_feature_course_rationale_enabled' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '0'],
        'ai_placement_supervisor_review' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '0'],
        'ai_placement_admin_analytics' => ['type' => 'tinyint', 'null' => 'NO', 'default' => '0'],
        'ai_timeout_seconds' => ['type' => 'int', 'null' => 'NO', 'default' => '20'],
        'ai_max_output_tokens' => ['type' => 'int', 'null' => 'NO', 'default' => '700'],
        'ai_temperature' => ['type' => 'decimal', 'null' => 'NO', 'default' => '0.20'],
        'ai_retry_count' => ['type' => 'int', 'null' => 'NO', 'default' => '1'],
