...
CREATE TABLE site_config (
  ...
  assessment_timer_enabled TINYINT(1) NOT NULL DEFAULT 0,
  assessment_timer_minutes INT NOT NULL DEFAULT 60,
  assessment_timer_warning_minutes INT NOT NULL DEFAULT 5,
  assessment_timer_expiry_behavior VARCHAR(40) NOT NULL DEFAULT 'message_only',
...
CREATE TABLE users (
  ...
  work_experience_profile VARCHAR(255) NULL,
  total_work_experience_band VARCHAR(50) NULL,
  epss_work_experience_band VARCHAR(50) NULL,
