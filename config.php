...
function ensure_site_config_schema(PDO $pdo): void {
    ...
    $schema = [
        ...
        'self_registration_enabled' => 'ALTER TABLE site_config ADD COLUMN self_registration_enabled TINYINT(1) NOT NULL DEFAULT 1 AFTER local_login_enabled',
        ...
        'scheduled_assessments_enabled' => 'ALTER TABLE site_config ADD COLUMN scheduled_assessments_enabled TINYINT(1) NOT NULL DEFAULT 1',
        'qb_danger_zone_enabled' => 'ALTER TABLE site_config ADD COLUMN qb_danger_zone_enabled TINYINT(1) NOT NULL DEFAULT 1',
        'assessment_timer_enabled' => 'ALTER TABLE site_config ADD COLUMN assessment_timer_enabled TINYINT(1) NOT NULL DEFAULT 0',
        'assessment_timer_minutes' => 'ALTER TABLE site_config ADD COLUMN assessment_timer_minutes INT NOT NULL DEFAULT 60',
        'assessment_timer_warning_minutes' => 'ALTER TABLE site_config ADD COLUMN assessment_timer_warning_minutes INT NOT NULL DEFAULT 5',
        'assessment_timer_expiry_behavior' => "ALTER TABLE site_config ADD COLUMN assessment_timer_expiry_behavior VARCHAR(40) NOT NULL DEFAULT 'message_only'",
...
function site_config_defaults(): array
{
    return [
        ...
        'review_enabled' => 1,
        'scheduled_assessments_enabled' => 1,
        'qb_danger_zone_enabled' => 1,
        'assessment_timer_enabled' => 0,
        'assessment_timer_minutes' => 60,
        'assessment_timer_warning_minutes' => 5,
